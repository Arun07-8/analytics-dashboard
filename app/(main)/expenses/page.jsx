                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                        ...
                        <div className="flex items-center gap-3 animate-in fade-in slide-in-from-left-2 duration-300 w-full sm:w-auto">
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button variant="outline" className={cn("h-10 justify-start text-left font-bold text-[12px] bg-card pl-3 pr-4 border border-border/50 shadow-sm rounded-xl hover:bg-muted/50 hover:border-border transition-all w-full", !fromDate && "text-muted-foreground")}>
                    ...
                    {dateFilter === 'custom' && (
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 animate-in fade-in slide-in-from-left-2 duration-300 w-full sm:w-auto">
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button variant="outline" className={cn("h-10 justify-start text-left font-bold text-[12px] bg-card pl-3 pr-4 border border-border/50 shadow-sm rounded-xl hover:bg-muted/50 hover:border-border transition-all w-full sm:w-auto", !fromDate && "text-muted-foreground")}>
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button variant="outline" className={cn("h-10 justify-start text-left font-bold text-[12px] bg-card pl-3 pr-4 border border-border/50 shadow-sm rounded-xl hover:bg-muted/50 hover:border-border transition-all w-full sm:w-auto", !toDate && "text-muted-foreground")}>
